 ...
 *@Copyright  (c) 2019
 */
public class ProductShelfRequest implements CcsnRequest<ProductShelfResponse>{
	...
	public Class<ProductShelfResponse> getResponseClass() {
		return ProductShelfResponse.class;
	}
