...
/**
 * 
 *@Title: ProductB2cRequest.java  
 *@Package cn.ccsn.api.request  
 *@Description:分页查询线上商品商品参数对象
 *@author gaodaojiang@hotmail.com 
 *@date 2019年10月30日 下午12:14:40  
 *@version 1.0.0
 *@Copyright  (c) 2019
 */
public class ProductB2cRequest implements CcsnRequest<ProductB2cResponse>{
	...
	public Class<ProductB2cResponse> getResponseClass() {
		return ProductB2cResponse.class;
	}
