 ...
 *@Copyright  (c) 2019
 */
public class OrderUnifiedRequest implements CcsnRequest<OrderUnifiedResponse>{
	...
	public Class<OrderUnifiedResponse> getResponseClass() {
		return OrderUnifiedResponse.class;
	}
