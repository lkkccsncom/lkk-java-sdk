 ...
 *@Package cn.ccsn.api.request  
 *@Description:分页查询我的商品
 *@author gaodaojiang@hotmail.com 
 *@date 2019年10月30日 下午12:01:34  
 *@version 1.0.0
 *@Copyright  (c) 2019
 */
public class MyProductRequest implements CcsnRequest<MyProductResponse>{
	...
	public Class<MyProductResponse> getResponseClass() {
		return MyProductResponse.class;
	}
