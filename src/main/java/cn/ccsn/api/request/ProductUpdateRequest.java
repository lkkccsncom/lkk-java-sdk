 ...
 *@Copyright  (c) 2019
 */
public class ProductUpdateRequest implements CcsnRequest<ProductInfoResponse>{
	...
	public Class<ProductInfoResponse> getResponseClass() {
		return ProductInfoResponse.class;
	}
