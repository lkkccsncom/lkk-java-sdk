 ...
 *@Copyright  (c) 2019
 */
public class LotteryInfoRequest implements CcsnRequest<LotteryInfoResponse>{
	...
	public Class<LotteryInfoResponse> getResponseClass() {
		return LotteryInfoResponse.class;
	}
