...
public class CcsnConstants {
    ...
    public static List<String>SIGN_TYPE_LIST=new ArrayList<String>();
    static {
    	SIGN_TYPE_LIST.add(SIGN_TYPE_RSA);
    	SIGN_TYPE_LIST.add(SIGN_TYPE_RSA2);
