 ...
 *@Copyright  (c) 2019
 */
public class OrderUnifiedLkkRequest implements CcsnRequest<OrderUnifiedLkkResponse>{
	...
	public Class<OrderUnifiedLkkResponse> getResponseClass() {
		return OrderUnifiedLkkResponse.class;
	}
