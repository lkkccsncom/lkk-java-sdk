...
import cn.ccsn.api.kkm.response.UserLkkResponse;
/**
 * 
 ...
 *@Copyright  (c) 2019
 */
public class UserLkkRequest implements CcsnRequest<UserLkkResponse>{
	...
	public Class<UserLkkResponse> getResponseClass() {
		return UserLkkResponse.class;
	}
