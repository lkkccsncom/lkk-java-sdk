...
import cn.ccsn.api.kkm.response.OrderListLkkResponse;
import cn.ccsn.api.kkm.response.OrderUnifiedLkkResponse;
/**
 * 
 ...
 *@Copyright  (c) 2019
 */
public class OrderListLkkRequest implements CcsnRequest<OrderListLkkResponse>{
	...
	public Class<OrderListLkkResponse> getResponseClass() {
		return OrderListLkkResponse.class;
	}
