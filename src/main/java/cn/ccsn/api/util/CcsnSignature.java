...
import cn.ccsn.api.util.codec.Base64;

/**
 * 
 * @author runzhi
 */
public class CcsnSignature {
    ...
    public static Map<String, Object> getSortedMap(RequestParametersHolder requestHolder) {
        ...
        Map<String, Object> appParams = requestHolder.getApplicationParams();
        if (appParams != null && appParams.size() > 0) {
            sortedParams.putAll(appParams);
        }
        Map<String, Object> protocalMustParams = requestHolder.getProtocalMustParams();
        if (protocalMustParams != null && protocalMustParams.size() > 0) {
            sortedParams.putAll(protocalMustParams);
        }
        Map<String, Object> protocalOptParams = requestHolder.getProtocalOptParams();
    ...
    public static String rsaSign(String content, String privateKey, String charset,
                                 String signType) throws CcsnApiException {

        if (CcsnConstants.SIGN_TYPE_RSA.equals(signType)) {

            return rsaSign(content, privateKey, charset);
        } else if (CcsnConstants.SIGN_TYPE_RSA2.equals(signType)) {

            return rsa256Sign(content, privateKey, charset);
        } else {

            throw new CcsnApiException("Sign Type is Not Support : signType=" + signType);
        }
    ...
    public static String rsa256Sign(String content, String privateKey,
                                    String charset) throws CcsnApiException {

        try {
            PrivateKey priKey = getPrivateKeyFromPKCS8(CcsnConstants.SIGN_TYPE_RSA,
                new ByteArrayInputStream(privateKey.getBytes()));

            java.security.Signature signature = java.security.Signature
                .getInstance(CcsnConstants.SIGN_SHA256RSA_ALGORITHMS);
            ...
            throw new CcsnApiException("RSAcontent = " + content + "; charset = " + charset, e);
        }
    ...
    public static String rsaSign(String content, String privateKey,
        ...
        try {
            ...
            java.security.Signature signature = java.security.Signature
                .getInstance(CcsnConstants.SIGN_ALGORITHMS);
            ...
            throw new CcsnApiException("RSA私钥格式不正确，请检查是否正确配置了PKCS8格式的私钥", ie);
        } catch (Exception e) {
            throw new CcsnApiException("RSAcontent = " + content + "; charset = " + charset, e);
        }
    }
    ...
    public static String getSignCheckContentV1(Map<String, Object> params) {
        if (params == null) {
            return null;
        }
    ...
    public static boolean rsaCheckV1(Map<String, Object> params, String publicKey,
                                     String charset) throws CcsnApiException {
    ...
    public static boolean rsaCheckV1(Map<String, Object> params, String publicKey,
            String charset,String signType) throws CcsnApiException {
		String sign =String.valueOf( params.get("sign"));
		String content = getSignCheckContentV1(params);
    ...
    public static String checkSignAndDecrypt(Map<String, String> params, String alipayPublicKey,
                                             ...
                                             boolean isDecrypt) throws CcsnApiException {
        String charset = params.get("charset");
        String bizContent = params.get("biz_content");
        if (isCheckSign) {
            if (!rsaCheckV2(params, alipayPublicKey, charset)) {
                throw new CcsnApiException("rsaCheck failure:rsaParams=" + params);
            }
        }
    ...
    public static String checkSignAndDecrypt(Map<String, String> params, String alipayPublicKey,
                                             String cusPrivateKey, boolean isCheckSign,
                                             boolean isDecrypt, String signType) throws CcsnApiException {
        String charset = params.get("charset");
        String bizContent = params.get("biz_content");
        if (isCheckSign) {
    ...
    public static String encryptAndSign(String bizContent, String alipayPublicKey,
                                        ...
                                        boolean isSign) throws CcsnApiException {
        StringBuilder sb = new StringBuilder();
        if (StringUtils.isEmpty(charset)) {
            charset = CcsnConstants.CHARSET_GBK;
        }
    ...
    public static String encryptAndSign(String bizContent, String alipayPublicKey,
                                        String cusPrivateKey, String charset, boolean isEncrypt,
                                        boolean isSign,String signType) throws CcsnApiException {
        StringBuilder sb = new StringBuilder();
        if (StringUtils.isEmpty(charset)) {
            charset = CcsnConstants.CHARSET_GBK;
        }
    ...
    public static String rsaEncrypt(String content, String publicKey,
                                    String charset) throws CcsnApiException {
        try {
            PublicKey pubKey = getPublicKeyFromX509(CcsnConstants.SIGN_TYPE_RSA,
                new ByteArrayInputStream(publicKey.getBytes()));
            Cipher cipher = Cipher.getInstance(CcsnConstants.SIGN_TYPE_RSA);
            ...
            throw new CcsnApiException("EncryptContent = " + content + ",charset = " + charset,
                e);
        }
    }
    ...
    public static String rsaDecrypt(String content, String privateKey,
        ...
        try {
            ...
            throw new CcsnApiException("EncodeContent = " + content + ",charset = " + charset, e);
        }
    }
